...
Rails.application.routes.draw do
    ...
    get '/representatives/:id', to: 'representatives#show', as: :representative


    root to: 'map#index', as: 'root'
    get '/state/:state_symbol' => 'map#state', :as => :state_map
    get '/state/:state_symbol/county/:std_fips_code/:address' => 'search#search', :as => :county
    ...
    get '/campaignfinance' => 'campaigns#index', :as => 'campaign_finance'
    post '/campaignfinance' => 'campaigns#search', :as => 'campaign_finance_search'
end
